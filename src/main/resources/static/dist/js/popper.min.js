...
function _(e, t) {
    return q(e).removeEventListener('resize', t.updateBound), t.scrollParents.forEach((e) = > {
        e
        .removeEventListener('scroll', t.updateBound)
    }
),
...
function te(e, t) {
    ...
    const {x: i, y: r} = t, {popper: p} = e.offsets, d = F(e.instance.modifiers, (e) = > 'applyStyle' === e.name
).
    gpuAcceleration;
...
function me(e, t, o, n) {
    ...
    f.forEach((e, t) = > {e.forEach((o, n) = > {Q(o) && (i[t] += o * ('-' === e[n - 1] ? -1 : 1))}
)
}),
    i
}
...
class Ee {
    ...
    >
        requestAnimationFrame(this.update), this.update = p(this.update.bind(this)), this.options = O({}, Ee.Defaults, o), this.state = {
            ...
            this
            .options.modifiers[e] = O({}, Ee.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
        }
    ),
        ...
        this.modifiers.forEach((e) = > {
            e
            .enabled && d(e.onLoad) && e.onLoad(this.reference, this.popper, this.options, e, this.state)
        }
    ),
        this.update();
